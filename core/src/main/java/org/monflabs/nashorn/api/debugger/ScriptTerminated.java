...
/**
 * Thrown through a script when {@link PausedEvent#terminate()} ends it. An
 * {@link Error} rather than an exception, so that script code catching what
...
public final class ScriptTerminated extends Error {
     ...
     * Creates the error.
     */
    public ScriptTerminated() {
        super("script terminated by the debugger", null, false, false);
    }
}
