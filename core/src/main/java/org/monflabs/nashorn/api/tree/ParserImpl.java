 ...
 * questions.
 */
package org.monflabs.nashorn.api.tree;
...
final class ParserImpl implements Parser {
    ...
    private org.monflabs.nashorn.internal.parser.Parser makeParser(final Source source, final DiagnosticListener listener) {
        final ErrorManager errMgr = listener != null ? new ListenerErrorManager(listener) : new Context.ThrowErrorManager();
        return new org.monflabs.nashorn.internal.parser.Parser(env, source, errMgr);
    }
