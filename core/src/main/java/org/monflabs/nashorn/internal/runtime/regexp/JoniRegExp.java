...
import org.monflabs.nashorn.internal.runtime.regexp.joni.Matcher;
import org.monflabs.nashorn.internal.runtime.regexp.joni.Option;
import org.monflabs.nashorn.internal.runtime.regexp.joni.Regex;
import org.monflabs.nashorn.internal.runtime.regexp.joni.Region;
import org.monflabs.nashorn.internal.runtime.regexp.joni.Syntax;
import org.monflabs.nashorn.internal.runtime.regexp.joni.exception.JOniException;
...
public class JoniRegExp extends RegExp {
    ...
    public JoniRegExp(final String pattern, final String flags) throws ParserException {
        ...
        try {
            ...
            try {
                parsed = RegExpScanner.scan(pattern, isUnicode(), RegExpFactory.annexBEnabled());
