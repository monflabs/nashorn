...
import org.monflabs.nashorn.internal.codegen.DumpBytecode;
    ...
    private ClassLoader createClassLoader(final ClassLoader parentLoader) {
        return new ClassLoader(parentLoader) {
...

            {
                ...
                NASHORN_MODULE.addExports("org.monflabs.nashorn.internal.runtime", adapterModule);
                NASHORN_MODULE.addExports("org.monflabs.nashorn.internal.runtime.linker", adapterModule);
            ...
            protected Class<?> findClass(final String name) throws ClassNotFoundException {
                if(name.equals(className)) {
                    ...
                    DumpBytecode.dumpBytecode(ctx.getEnv(), ctx.getLogger(org.monflabs.nashorn.internal.codegen.Compiler.class), classBytes, name);
