...
import org.monflabs.nashorn.internal.scripts.JD;
import org.monflabs.nashorn.internal.scripts.JO;
import org.monflabs.nashorn.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    private static final String PACKAGE_PREFIX = "org.monflabs.nashorn.internal.objects.";
    ...
    public static Object directEval(final Object self, final Object str, final Object callThis,
        ...
        return directEval(self, str, callThis, location, strict, inParameters, null);
    }

    /**
     * Direct eval, from a call site that knows what function it sits in.
     *
     * @param self       The scope of eval passed as 'self'
     * @param str        Evaluated code
     * @param callThis   "this" to be passed to the evaluated code
    ...
    public static Object directEval(final Object self, final Object str, final Object callThis,
        ...
        return global.getContext().eval(scope, str.toString(), callThis, location, strict, true, inParameters, callee);
    }
    ...
    /**
     * %TypedArray%, the intrinsic the nine typed array constructors inherit from.
     *
     * ES2015 22.2.1 gives it no name in the global object: a script can only
    ...
    private static ScriptObject arrayUnscopables() {
        ...
        for (final String name : new String[] {
                "at", "copyWithin", "entries", "fill", "find", "findIndex", "flat", "flatMap",
    ...
    private synchronized ScriptFunction getBuiltinTypedArray() {
        if (this.builtinTypedArray == null) {
            ...
            final ScriptObject prototype = ScriptFunction.getPrototype(typedArray);
            // 22.2.3.29: values and [ @@iterator ] are the same function object,
            // and 22.2.3.28 makes toString the one Array.prototype has
            prototype.addOwnProperty(NativeSymbol.iterator, Attribute.NOT_ENUMERABLE, prototype.get("values"));
            prototype.addOwnProperty("toString", Attribute.NOT_ENUMERABLE, getArrayPrototype().get("toString"));
            this.builtinTypedArray = typedArray;
        }
        return this.builtinTypedArray;
    }

    /**
     * Puts one concrete typed array constructor and its prototype under
     * %TypedArray% (ES2015 22.2.4, 22.2.6), which is where everything they share
     * lives.
     */
    private ScriptFunction initTypedArrayConstructor(final String name) {
        final ScriptFunction constructor = initConstructorAndSwitchPoint(name, ScriptFunction.class);
        final ScriptFunction typedArray = getBuiltinTypedArray();
        constructor.setProto(typedArray);
        ScriptFunction.getPrototype(constructor).setProto(ScriptFunction.getPrototype(typedArray));
        return constructor;
    }
    ...
    public static boolean isBuiltinArrayPrototypeIterator() {
        ...
        final org.monflabs.nashorn.internal.runtime.Property next =
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final org.monflabs.nashorn.internal.runtime.Property[] properties) {
        ...
        for (final org.monflabs.nashorn.internal.runtime.Property property : properties) {
            if (property.isLexicalBinding()) {
                hasLexicalDefinitions = true;
            }
            // ES6 15.1.8 steps 6. and 7.
            final org.monflabs.nashorn.internal.runtime.Property globalProperty = ownMap.findProperty(property.getKey());
            ...
            final org.monflabs.nashorn.internal.runtime.Property lexicalProperty = lexicalMap.findProperty(property.getKey());
        ...
        for (final org.monflabs.nashorn.internal.runtime.Property property : properties) {
            if (property.isLexicalBinding()) {
                final org.monflabs.nashorn.internal.runtime.Property existing = lexicalMap.findProperty(property.getKey());
    ...
    private void init(final ScriptEngine eng) {
        ...
        final org.monflabs.nashorn.internal.runtime.Property proxyPrototype =
    ...
    private List<org.monflabs.nashorn.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<org.monflabs.nashorn.internal.runtime.Property> list = new ArrayList<>();
        ...
        final org.monflabs.nashorn.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final org.monflabs.nashorn.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        // 9.2.7.1 gives %ThrowTypeError% the empty string for a name, which is
        // what a caller reading it off the accessor it stands behind sees
        this.typeErrorThrower = ScriptFunction.createBuiltin("", Lookup.TYPE_ERROR_THROWER);
        ...
        org.monflabs.nashorn.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final org.monflabs.nashorn.internal.runtime.Property property : properties) {
        ...
        for (final org.monflabs.nashorn.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source, final org.monflabs.nashorn.internal.runtime.Property property, final boolean extensible) {
