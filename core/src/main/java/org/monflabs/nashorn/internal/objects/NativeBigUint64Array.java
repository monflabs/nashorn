...
/**
 * BigUint64Array (ES2020 22.2): a typed array whose elements are 64-bit
 * unsigned BigInt values.
 */
@ScriptClass("BigUint64Array")
public final class NativeBigUint64Array extends ArrayBufferView {
    /** 2^64, for reinterpreting a stored long as an unsigned value. */
    ...
    private static final Factory FACTORY = new Factory(BYTES_PER_ELEMENT) {
        ...
        public ArrayBufferView construct(final NativeArrayBuffer buffer, final int byteOffset, final int length) {
            return new NativeBigUint64Array(buffer, byteOffset, length);
        }

        @Override
        public BigUint64ArrayData createArrayData(final ByteBuffer nb, final int start, final int length) {
            return new BigUint64ArrayData(nb.asLongBuffer(), start, length);
        }
    ...
    private static final class BigUint64ArrayData extends TypedArrayData<LongBuffer> {

        private BigUint64ArrayData(final LongBuffer nb, final int start, final int end) {
        ...
        public Object getObject(final int index) {
            final long v = getElem(index);
            return v >= 0 ? BigInteger.valueOf(v) : BigInteger.valueOf(v).add(TWO_64);
        }
     ...
     */
    @Constructor(arity = 3)
    public static NativeBigUint64Array constructor(final boolean newObj, final Object self, final Object... args) {
        return (NativeBigUint64Array)constructorImpl(newObj, args, FACTORY);
    }

    NativeBigUint64Array(final NativeArrayBuffer buffer, final int byteOffset, final int length) {
    ...
    protected ScriptObject getPrototype(final Global global) {
        return global.getBigUint64ArrayPrototype();
    }
