...
import static org.monflabs.nashorn.internal.codegen.Compiler.binaryName;
...
final class StructureLoader extends NashornLoader {
    ...
    private Module createModule() {
        final ModuleDescriptor descriptor =
            ModuleDescriptor.newModule("org.monflabs.nashorn.structures", Set.of(Modifier.SYNTHETIC))
