...
import static org.monflabs.nashorn.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static org.monflabs.nashorn.internal.codegen.ClassEmitter.Flag.STATIC;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.ARGUMENTS;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.CALLEE;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.CREATE_PROGRAM_FUNCTION;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.GET_MAP;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.GET_STRING;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.REGEX_PREFIX;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.SCOPE;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.SPLIT_PREFIX;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.THIS;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.VARARGS;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.interfaceCallNoLookup;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.methodDescriptor;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.staticCallNoLookup;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.typeDescriptor;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.virtualCallNoLookup;
import static org.monflabs.nashorn.internal.ir.Symbol.HAS_SLOT;
import static org.monflabs.nashorn.internal.ir.Symbol.IS_INTERNAL;
...
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_DECLARE;
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_FAST_SCOPE;
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_OPTIMISTIC;
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_PROGRAM_POINT_SHIFT;
import static org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_SCOPE;
...
import org.monflabs.nashorn.internal.AssertsEnabled;
import org.monflabs.nashorn.internal.IntDeque;
import org.monflabs.nashorn.internal.codegen.ClassEmitter.Flag;
...
import org.monflabs.nashorn.internal.ir.GetSplitState;
...
import org.monflabs.nashorn.internal.ir.LocalVariableConversion;
...
import org.monflabs.nashorn.internal.ir.RuntimeNode.Request;
import org.monflabs.nashorn.internal.ir.SetSplitState;
import org.monflabs.nashorn.internal.ir.SplitReturn;
import org.monflabs.nashorn.internal.ir.Splittable;
...
import org.monflabs.nashorn.internal.parser.Lexer.RegexToken;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private static final Call RETHROW_IF_ABORT = CompilerConstants.staticCallNoLookup(
            org.monflabs.nashorn.internal.runtime.GeneratorSupport.class,
    ...
    public boolean enterVarNode(final VarNode varNode) {
        ...
        if (needsScope) {
            ...
            if (resolveFirst) {
                ...
                method.load(identNode.getName());
                method.swap();
                method.load(org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.isStrictFlag(getCallSiteFlags()));
    ...
    private boolean resolvesReferenceFirst(final IdentNode ident) {
        ...
        return !isFastScope(symbol)
                || (symbol.isGlobal() && org.monflabs.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.isStrictFlag(getCallSiteFlags()));
    }
    ...
    private void globalAllocateArray(final ArrayType type) {
        ...
        method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lorg/monflabs/nashorn/internal/objects/NativeArray;");
    }
