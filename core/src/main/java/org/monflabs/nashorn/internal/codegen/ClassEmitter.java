...
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.GET_ARRAY_PREFIX;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.GET_ARRAY_SUFFIX;
...
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.INIT;
import static org.monflabs.nashorn.internal.codegen.CompilerConstants.SET_MAP;
...
import org.monflabs.nashorn.internal.ir.debug.BytecodePrinter;
...
public class ClassEmitter {
    ...
    ClassEmitter(final Context context, final String sourceName, final String unitClassName, final boolean strictMode) {
        this(context, unitClassName, pathName(org.monflabs.nashorn.internal.scripts.JS.class.getName()),
    ...
    public void end() {
        ...
        if (unitClassName != null) {
            ...
            initMethod.newInstance(org.monflabs.nashorn.internal.scripts.JS.class);
