 ...
 * </pre>
 * You can also use {@link org.monflabs.nashorn.internal.objects.NativeJava#type(Object, Object)} to access Java classes. These two statements are mostly
 * equivalent:
 * <pre>
...
public final class NativeJavaPackage extends ScriptObject {
    ...
    /**
     * Public constructor to be accessible from {@link org.monflabs.nashorn.internal.objects.Global}
