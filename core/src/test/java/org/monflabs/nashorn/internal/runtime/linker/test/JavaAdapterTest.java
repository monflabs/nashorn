 ...
 * questions.
 */
package org.monflabs.nashorn.internal.runtime.linker.test;
...
public class JavaAdapterTest {
    ...
    public static void testMirrorAdapter() throws ScriptException {
        ...
        e.eval("function convertParamFromEngineScope(){ return Java.type('org.monflabs.nashorn.internal.runtime.linker.test.JavaAdapterTest').m(f);}", e.getBindings(ScriptContext.ENGINE_SCOPE));
        e.eval("function convertParamFromGlobalScope(){ return Java.type('org.monflabs.nashorn.internal.runtime.linker.test.JavaAdapterTest').m(f);}", e.getBindings(ScriptContext.GLOBAL_SCOPE));
