...
/**
 * Tests for pluggable external impls. of org.monflabs.nashorn.api.scripting.JSObject.
 *
 * JDK-8024615: Refactor ScriptObjectMirror and JSObject to support external
 * JSObject implementations.
 *
 * @test
 * @run testng org.monflabs.nashorn.api.scripting.test.PluggableJSObjectTest
 */
