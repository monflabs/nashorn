...
/**
 * @test
 * @build org.monflabs.nashorn.api.javaaccess.test.SharedObject org.monflabs.nashorn.api.javaaccess.test.Person org.monflabs.nashorn.api.javaaccess.test.MethodAccessTest
 * @run testng/othervm org.monflabs.nashorn.api.javaaccess.test.MethodAccessTest
 */
...
public class MethodAccessTest {
    ...
    public void accessDefaultConstructor() throws ScriptException {
        e.eval("var dc = new Packages.org.monflabs.nashorn.api.javaaccess.test.Person()");
        assertEquals(new Person(), e.get("dc"));
    }

    @Test
    public void accessCustomConstructor() throws ScriptException {
        e.eval("var cc = new Packages.org.monflabs.nashorn.api.javaaccess.test.Person(17)");
