...
// Java types used
Parser.Diagnostic = Java.type("org.monflabs.nashorn.api.tree.Diagnostic");
Parser.SimpleTreeVisitor = Java.type("org.monflabs.nashorn.api.tree.SimpleTreeVisitorES5_1");
Parser.Tree = Java.type("org.monflabs.nashorn.api.tree.Tree");
...
Parser.create = function() {
    return Java.type("org.monflabs.nashorn.api.tree.Parser").create();
}
