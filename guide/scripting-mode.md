...
```bash
java -cp nashorn-core-2026.0.0.jar org.monflabs.nashorn.tools.Shell -scripting script.js
```
...
```js
#!/usr/bin/env -S java -cp nashorn-core-2026.0.0.jar org.monflabs.nashorn.tools.Shell -scripting
