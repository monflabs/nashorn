...
version 2024.0.0, reporting itself as *OpenJDK-Monflabs* — implements **ECMAScript 2024** (ECMA-262, 15th
...
playground/target/nashorn-playground-2024.0.0-all.jar` after `mvn -pl playground -am package`) whose
