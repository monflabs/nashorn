...
version 2018.0.0, reporting itself as *OpenJDK-Monflabs* — implements **ECMAScript 2018** (ECMA-262, 9th
...
playground/target/nashorn-playground-2018.0.0-all.jar` after `mvn -pl playground -am package`) whose
