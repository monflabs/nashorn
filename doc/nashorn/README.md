...
version 2022.0.0, reporting itself as *OpenJDK-Monflabs* — implements **ECMAScript 2022** (ECMA-262, 13th
...
playground/target/nashorn-playground-2022.0.0-all.jar` after `mvn -pl playground -am package`) whose
