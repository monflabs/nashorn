...
version 2020.0.0, reporting itself as *OpenJDK-Monflabs* — implements **ECMAScript 2020** (ECMA-262, 11th
...
playground/target/nashorn-playground-2020.0.0-all.jar` after `mvn -pl playground -am package`) whose
