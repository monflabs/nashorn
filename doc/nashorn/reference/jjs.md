...
java -cp nashorn-core-2026.0.0.jar org.monflabs.nashorn.tools.Shell -scripting script.js -- arg1 arg2
```
...
`nashorn-shell` is built by the reactor (`mvn package` → `shell/target/nashorn-shell-2026.0.0.jar`) but
...
```bash
java --module-path nashorn-core-2026.0.0.jar:nashorn-shell-2026.0.0.jar \
