...
```bash
java -cp nashorn-core-2021.0.0.jar org.monflabs.nashorn.tools.Shell script.js
java -cp nashorn-core-2021.0.0.jar org.monflabs.nashorn.tools.Shell -scripting script.js -- arg1 arg2
```
...
```bash
java -cp nashorn-core-2021.0.0.jar:nashorn-debugger-2021.0.0.jar org.monflabs.nashorn.tools.Shell --inspect-brk script.js
```

## Running jjs

`nashorn-shell` is built by the reactor (`mvn package` → `shell/target/nashorn-shell-2021.0.0.jar`) but
...
```bash
java --module-path nashorn-core-2021.0.0.jar:nashorn-shell-2021.0.0.jar \
