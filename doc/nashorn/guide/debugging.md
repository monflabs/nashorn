...
```bash
java -cp nashorn-core-2020.0.0.jar:nashorn-debugger-2020.0.0.jar org.monflabs.nashorn.tools.Shell --inspect script.js
```
...
```bash
java --module-path nashorn-core-2020.0.0.jar:nashorn-debugger-2020.0.0.jar --add-modules org.monflabs.nashorn.debugger \
