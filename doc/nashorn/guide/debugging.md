...
```bash
java -cp nashorn-core-20.jar:nashorn-debugger-20.jar org.monflabs.nashorn.tools.Shell --inspect script.js
```
...
```bash
java --module-path nashorn-core-20.jar:nashorn-debugger-20.jar --add-modules org.monflabs.nashorn.debugger \
