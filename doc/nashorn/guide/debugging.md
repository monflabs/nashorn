...
```bash
java -cp nashorn-core-2025.0.1.jar:nashorn-debugger-2025.0.1.jar org.monflabs.nashorn.tools.Shell --inspect script.js
```
...
```bash
java --module-path nashorn-core-2025.0.1.jar:nashorn-debugger-2025.0.1.jar --add-modules org.monflabs.nashorn.debugger \
