...
```bash
java -cp nashorn-core-2025.0.1.jar org.monflabs.nashorn.tools.Shell -scripting script.js
```
...
```js
#!/usr/bin/env -S java -cp nashorn-core-2025.0.1.jar org.monflabs.nashorn.tools.Shell -scripting
