...
```bash
java -cp nashorn-core-2022.0.0.jar org.monflabs.nashorn.tools.Shell -scripting script.js
```
...
```js
#!/usr/bin/env -S java -cp nashorn-core-2022.0.0.jar org.monflabs.nashorn.tools.Shell -scripting
