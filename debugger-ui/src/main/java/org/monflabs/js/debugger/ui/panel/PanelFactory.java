 ...
 * {@link org.monflabs.js.debugger.ui.DebuggerPanel} in the neighbouring
...
public final class PanelFactory {
    ...
    private void source0(final org.monflabs.js.debugger.ui.model.ScriptInfo script) {
        source.open(script);
    }
    ...
    private final class BreakpointActions implements BreakpointListPanel.Actions {
        ...
        public void reveal(final String url, final int line) {
            for (final org.monflabs.js.debugger.ui.model.ScriptInfo script : session.scripts()) {
        ...
        public void removeAll() {
            for (final org.monflabs.js.debugger.ui.model.Breakpoint bp : session.breakpoints()) {
